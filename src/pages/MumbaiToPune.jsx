...
export default function MumbaiToPune() {
  ...
  useEffect(() => {
    async function fetchData() {
      const data = await getRouteBySlug('mumbai-to-pune')
      setRoute(data)
      setLoading(false)
    }
    fetchData()
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-8 md:px-12 lg:px-16">
          <div className="max-w-3xl">
            ...
            <p className="text-gray-600 dark:text-gray-400 text-sm sm:text-base md:text-lg font-light leading-relaxed">
              Direct highway transit service. Doorstep pickup across Mumbai (including CSMI Airport) to all areas in Pune & PCMC.
            </p>
          </div>
        </div>
      </section>
            ...
            <div className="space-y-4 pt-2">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 text-s font-mono text-gray-700 dark:text-gray-300">
                <span className="p-3 bg-gray-50 dark:bg-black border border-gray-200 dark:border-white/10 block">
                  &bull; Airport terminal pickup & drop
                </span>
                <span className="p-3 bg-gray-50 dark:bg-black border border-gray-200 dark:border-white/10 block">
          ...
          <div className="lg:col-span-5 space-y-4">
            ...
            <div className="bg-gray-50 dark:bg-black border border-gray-200 dark:border-white/15 p-6 sm:p-8 flex items-center justify-between gap-4">
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400 text-s mt-1">Mumbai to Pune direct</p>
              </div>
            ...
            <div className="bg-gray-50 dark:bg-black border border-gray-200 dark:border-white/15 p-6 sm:p-8 flex items-center justify-between gap-4">
              <div>
                ...
                <p className="text-gray-500 dark:text-gray-400 text-s mt-1">Mumbai &rarr; Pune &rarr; Mumbai</p>
              </div>
              <div className="text-right">
                <span className="text-3xl font-mono font-bold text-black dark:text-white block">
        ...
        <div className="pt-12 border-t border-gray-200 dark:border-white/10">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="p-6 bg-gray-50 dark:bg-black border border-gray-200 dark:border-white/10">
              <h3 className="text-base font-bold text-black dark:text-white mb-2">CSMI Airport Pickup</h3>
              <p className="text-gray-600 dark:text-gray-400 text-s font-light leading-relaxed">
                Direct pickup from T1 or T2 domestic & international terminals with flight arrival tracking.
              </p>
            </div>
            <div className="p-6 bg-gray-50 dark:bg-black border border-gray-200 dark:border-white/10">
              <h3 className="text-base font-bold text-black dark:text-white mb-2">Guaranteed Timings</h3>
              <p className="text-gray-600 dark:text-gray-400 text-s font-light leading-relaxed">
                Scheduled drivers arrive at your designated location 10 minutes prior to departure.
              </p>
            </div>
            <div className="p-6 bg-gray-50 dark:bg-black border border-gray-200 dark:border-white/10">
              <h3 className="text-base font-bold text-black dark:text-white mb-2">Fixed Billing</h3>
              <p className="text-gray-600 dark:text-gray-400 text-s font-light leading-relaxed">
                No dynamic surge pricing or hidden convenience fees applied at trip termination.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="pt-12 border-t border-gray-200 dark:border-white/10">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-x-12 gap-y-8">
            <div className="border-l border-gray-300 dark:border-white/20 pl-4">
              <h3 className="text-sm font-bold text-black dark:text-white mb-2">How does airport pickup work?</h3>
              <p className="text-gray-600 dark:text-gray-400 text-s font-light leading-relaxed">
                Provide your flight number during booking. Your driver monitors your arrival and coordinates directly upon landing.
              </p>
            </div>
            <div className="border-l border-gray-300 dark:border-white/20 pl-4">
              <h3 className="text-sm font-bold text-black dark:text-white mb-2">What if my flight is delayed?</h3>
              <p className="text-gray-600 dark:text-gray-400 text-s font-light leading-relaxed">
                We adjust pickup times automatically based on real-time flight tracking at no additional fee.
              </p>
            </div>
            <div className="border-l border-gray-300 dark:border-white/20 pl-4">
              <h3 className="text-sm font-bold text-black dark:text-white mb-2">Are toll charges extra?</h3>
              <p className="text-gray-600 dark:text-gray-400 text-s font-light leading-relaxed">
                No. Expressway toll taxes are included in the upfront fare.
              </p>
            </div>
            <div className="border-l border-gray-300 dark:border-white/20 pl-4">
              <h3 className="text-sm font-bold text-black dark:text-white mb-2">Can I request en-route stops?</h3>
              <p className="text-gray-600 dark:text-gray-400 text-s font-light leading-relaxed">
                Short rest stops along the Expressway (e.g., Food Mall) are included automatically.
              </p>
            </div>
          </div>
        </div>
